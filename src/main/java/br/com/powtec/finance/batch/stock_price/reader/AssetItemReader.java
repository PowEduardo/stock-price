...
public class AssetItemReader {
  ...
  public JpaPagingItemReader<AssetModel> reader(EntityManagerFactory entityManagerFactory) {
    ...
    reader.setQueryString("SELECT asset FROM AssetModel AS asset WHERE asset.type IN (AssetTypeEnum.STOCK, AssetTypeEnum.REIT) ORDER BY asset.ticker"); // Define a consulta para buscar os registros
